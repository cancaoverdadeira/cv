...
$genero_cfg = array(
    ...
    'sertanejo-romantico'     => array('icone' => '❤',  'cor' => '#F8E7E7', 'desc' => 'Amor, saudade e emoção'),
    'modao'                   => array('icone' => '🎩', 'cor' => '#F3EEED', 'desc' => 'O sertanejo raiz em sua forma mais pura'),
    'sertanejo-gospel'        => array('icone' => '✝',  'cor' => '#4169E1', 'desc' => 'Fé e espiritualidade com sotaque sertanejo'),
    'sertanejo-sofrencia'     => array('icone' => '💔', 'cor' => '#C9A27E', 'desc' => 'Paixão, dor e superação'),
    'sertanejo-pop'           => array('icone' => '🎤', 'cor' => '#9B59B6', 'desc' => 'O sertanejo que conquistou as cidades'),
);
$cfg = $genero_cfg[$genero_slug] ?? array('icone' => '🎵', 'cor' => '#B8700C', 'desc' => '');
...
<div class="cv-app" id="cv-app">
    ...
    <main class="cv-main" id="cv-main" role="main">
        ...
        <!-- Banner do gênero -->
        <div style="background:linear-gradient(135deg, <?php echo esc_attr($cfg['cor']); ?> 0%, #FFFFFF 60%);
            ...
            <div style="display:flex;gap:20px;flex-wrap:wrap">
                <div style="text-align:center;background:rgba(123,58,34,0.1);border-radius:10px;padding:12px 20px">
