...
class CV_Achievements {
    ...
    const BADGES = array(
        ...
        'plays_100'     => array( 'icon' => '🏅', 'name' => 'Fanatico',          'desc' => '100 musicas ouvidas',              'color' => '#D4A017' ),
        ...
        'first_rating'  => array( 'icon' => '⭐', 'name' => 'Critico Musical',  'desc' => 'Deu a primeira avaliacao',         'color' => '#f39c12' ),
